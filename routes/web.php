...
/*************CUADRES */
Route::get('/cuadres',[CuadresController::class,'index'])->name('cuadres.index');
Route::post('/cuadres/buscarMes',[CuadresController::class,'buscarMes'])->name('cuadres.buscarMes');
Route::get('/obtener-empresa-seleccionada',[EmpresasController::class,'obtenerEmpresaSeleccionada']);
Route::get('/cuadres-nuevo-registro',[CuadresController::class,'vistaRegistrarCuadre'])->name('cuadres.vistaRegistrarCuadre');
Route::post('/cuadres-seleccion-fecha',[CuadresController::class,'seleccionFechaRegistroCuadre'])->name('cuadres.seleccionFechaRegistroCuadre');
Route::get('/cuadres-listar-observaciones/{tipoObservacion}',[CuadresObservacionController::class,'obtenerObservacionCuadre']);
Route::post('/cuadres-guardar-observacion',[CuadresObservacionController::class,'guardarObservacion']);
Route::get('/cuadres-lista-empleados-arqueo',[CuadresObservacionController::class,'listaEmpleadosCuadre']);
Route::get('/cuadres-eliminar-observacion/{id}',[CuadresObservacionController::class,'eliminarObservacionCuadre']);

/*************CUADRES TRANSFERENCIAS */
Route::get('/cuadres-listar-transferencias',[CuadresTransferenciaController::class,'index']);
Route::post('/cuadres-registro-transferencias',[CuadresTransferenciaController::class,'guardarTransferenciaCuadre']);
Route::get('/cuadres-eliminar-transferencias/{id}',[CuadresTransferenciaController::class,'eliminarTransferenciaCuadre']);
Route::get('/cuadres-listar-transferencias-siace',[CuadresTransferenciaController::class,'transferenciasDelSiace']);

/*************CUADRES PRESTAMOS EN EFECTIVO */
Route::get('/cuadres-listar-prestamo-efectivo',[CuadresPrestamoEfectivoController::class,'index']);
Route::post('/cuadres-guardar-prestamo-efectivo',[CuadresPrestamoEfectivoController::class,'guardarPrestamoEfectivo']);
Route::get('/cuadres-eliminar-prestamo-efectivo/{id}',[CuadresPrestamoEfectivoController::class,'eliminar']);
...
Route::get('configuracion/cuentasPorPagar',[ConfiguracionController::class,'indexConfiguracionCuentasPorPagar'])->name('indexConfiguracionCuentasPorPagar');
Route::post('configuracion/cuentasPorPagar',[ConfiguracionController::class,'guardarConfiguracionCuentasPorPagar'])->name('guardarConfiguracionCuentasPorPagar');
Route::get('configuracion/general',[ConfiguracionController::class,'configuracionGeneral'])->name('configuracionGeneral');
Route::post('configuracion/general',[ConfiguracionController::class,'guardarConfiguracionGeneral'])->name('guardarConfiguracionGeneral');
Route::get('configuracion/cuentasPorPagar-sincronizar-server',[ConfiguracionController::class,'sincorinzarServidoresTraerUltimosRegistros'])->name('sincorinzarServidores');
Route::get('configuracion/cuentasPorPagar-sincronizar-todo-server',[ConfiguracionController::class,'sincorinzarServidoresTraerTodosLosRegistros'])->name('sincorinzarServidoresTodo');
...
Route::get('/cuentaspagadas',[CuentasPorPagarController::class,'litarCunetasPagadas'])->name('listarcuentaspagadas.index');
...
Route::get('/cuentaspagadas-reportepagos',[ReportesCuentasPorPagarController::class,'reporteCuentasPagadas'])->name('reportecuntaspagas');
Route::post('/cuentaspagadas-reportepagos',[ReportesCuentasPorPagarController::class,'buscarReporteCuentasPagadas'])->name('buscar.reportecuentaspagadas');
Route::get('/reporte-cuentasporpagar-reportePagosEmpresa',[ReportesCuentasPorPagarController::class,'reporteRelacionPagosPorEmpresa'])->name('reporteRelacionPagosPorEmpresa');
Route::post('/reporte-cuentasporpagar-reportePagosEmpresa',[ReportesCuentasPorPagarController::class,'resultadoReporteRelacionPagosPorEmpresa'])->name('resultadoReporteRelacionPagosPorEmpresa');
Route::get('/reporte-cuentasporpagar-proveedorTodasEmpresa',[ReportesCuentasPorPagarController::class,'reportePagoPorProvedorTodasEmpresas'])->name('reportePagoPorProvedorTodasEmpresas');
Route::post('/reporte-cuentasporpagar-proveedorTodasEmpresa',[ReportesCuentasPorPagarController::class,'resultadoReportePagoPorProvedorTodasEmpresas'])->name('resultadoReportePagoPorProvedorTodasEmpresas');
...
Route::get('/detalleretenciones/edit/{id}/{idRetencion}',[islrController::class,'editDetalles'])->name('islr.detalle.edit');
...
Route::get('/ut',[UtController::class,'index'])->name('ut.index');
Route::get('/ut/create',[UtController::class,'create'])->name('ut.create');
Route::post('/ut/create',[UtController::class,'save'])->name('ut.save');
Route::get('/ut/edit/{id?}',[UtController::class,'edit'])->name('ut.edit');
Route::PUT('/ut/edit/{id}',[UtController::class,'update'])->name('ut.update');
/*FIN Registro de la unidad Tributaria*/

/*Recursos Humanos ISLR*/
Route::get('/rrhh',[rrhhController::class,'index'])->name('rrhh.index');
Route::get('/rrhh/destroy/{id}/{empresaRif?}/{accion?}/{idxml?}/{fechaIniFin?}',[rrhhController::class,'destroy'])->name('rrhh.destroy');
Route::post('/rrhh/import-excel',[rrhhController::class,'importExcel'])->name('import-list-excel');
Route::get('/rrhh/edit/{id}/{empresa}/{accion?}/{idxml?}/{fechaIniFin?}',[rrhhController::class,'edit'])->name('rrhh.edit');
Route::put('/rrhh/edit/{id}/{accion?}/{idxml?}/{fechaIniFin?}',[rrhhController::class,'update'])->name('rrhh.update');
Route::get('/rrhh/create',[rrhhController::class,'create'])->name('rrhh.create');
Route::post('/rrhh/create',[rrhhController::class,'saveRrhh'])->name('rrhh.save');
Route::post('/rrhh/empresa',[rrhhController::class,'postIndex'])->name('rrhh.postindex');
Route::get('/rrhh/export/{rif?}',[rrhhController::class,'exportarRrhhCsv'])->name('rrhh.export');
Route::post('/rrhh/update-all',[rrhhController::class,'updateMasivo'])->name('updateMasivo');
/* FIN Recursos Humanos*/


/*tipos de contribuyentes natural, juridico empleado ISLR*/
Route::get('/contribuyentes',[contribuyenteController::class,'index'])->name('contribuyente.index');
Route::get('/contribuyentes/create',[contribuyenteController::class,'create'])->name('contribuyente.create');
Route::get('/contribuyentes/edit/{id}',[contribuyenteController::class,'edit'])->name('contribuyente.edit');
Route::post('/contribuyentes/create',[contribuyenteController::class,'save'])->name('contribuyente.save');
Route::put('/contribuyentes/edit/{id}',[contribuyenteController::class,'update'])->name('contribuyente.update');
Route::get('/contribuyentes/destroy/{id}',[contribuyenteController::class,'destroy'])->name('contribuyente.destroy');
/* FIN tipos de contribuyentes natural, juridico empleado*/


/*REgistro de los empleados que declaran Impuesto ISLR*/
Route::get('/declarantes',[EmpleadoDeclaranteController::class,'index'])->name('declarantes.index');
Route::get('/declarantes/create',[EmpleadoDeclaranteController::class,'create'])->name('declarantes.create');
Route::post('/declarantes/create',[EmpleadoDeclaranteController::class,'save'])->name('declarantes.save');
Route::get('/declarantes/delete/{id}/{empresaRif?}/{accion?}/{idxml?}/{fechaIniFin?}',[EmpleadoDeclaranteController::class,'destroy'])->name('declarantes.delete');
Route::get('/declarantes/edit/{id}/{accion?}/{idxml?}/{fechaIniFin?}',[EmpleadoDeclaranteController::class,'edit'])->name('declarantes.edit');
Route::put('/declarantes/update/{id}/{accion?}/{idxml?}/{fechaIniFin?}',[EmpleadoDeclaranteController::class,'updateSalarios'])->name('declarantes.update.salario')	;
...
Route::get('/relacion-puntosdeventa',[OperacionesPuntosController::class,'index'])->name('porcentaje.puntosventas');
Route::post('/relacion-puntosdeventa',[OperacionesPuntosController::class,'relacionPorcentualPuntosVentas'])->name('mostart.porcentaje.puntosventas');
...
Route::get('vendedores-comision',[VendedorComisionController::class,'index'])->name('empleadosComisionEspecial');
Route::post('vendedores-comision',[VendedorComisionController::class,'guardar'])->name('guardarEmpleadosComisionEspecial');
Route::get('vendedor-comision-eliminar/{id}',[VendedorComisionController::class,'eliminar'])->name('eliminarEmpleadosComisionEspecial');
Route::get('vendedor-comision-editar/{id}',[VendedorComisionController::class,'editar'])->name('editarEmpleadosComisionEspecial');
Route::get('vendedor-comision-excel/{desde}/{hasta}',[InformesAdicionalesController::class,'reporteComisionPorVentasExcel'])->name('reporteComisionPorVentasExcel');

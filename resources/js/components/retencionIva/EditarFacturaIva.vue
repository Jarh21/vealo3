<template>
    <div>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Editar Factura :{{ objFactura.comprobante }}</h5>
        ...
        <!--fin modal Editar Cantidades-->
               ...
               <tr v-for="factura in facturas">
                    <td><input type="checkbox"  name="facturasPorRetener[]" onchange="isCheckBoxSeleccionado(factura.keycodigo)" class="CheckedAK" :v-bind="factura.keycodigo">{{factura.keycodigo}}</td>
  ...
  export default {
    ...
    mounted(){
            ...
            this.buscarFactura(this.keycodigo);           
    ...
    methods:{
        ...
        async buscarFactura(id){
            
            let resultado = await axios.get("buscar-factura/"+id);

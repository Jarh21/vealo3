...
<body>
    ...
    <!--    <div class="row row-cols-2 row-cols-md-2">-->
            ...
            <?php
                ...
                if($contador==1){ echo'<tr><td width="410px">';}
                if($contador==2){echo '<td width="410px">';}
                if($contador==3){echo '<td width="410px">';}
            ?>
            <!--<tr>
                <td width="500px">
                 INICIO DE LOS HABLADORES -->
                    <div class="text-center separador-habladores mt-2 mb-1">
                        ...
                        <img class="m-1" src="{{asset($logoEmpresa)}}" style="width: 70px">
                            <p class="h4 font-weight-bold mr-2 ml-2 height-hablador mt-0 pt-0 mb-0">{{$hablador['nombre']}}</p>
                            <div class="bg-navbar-gray">
                                
                                <p class="fuente-precios-reconvertidos-s font-weight-bold m-0 pt-2">{{$hablador['tipoMoneda']}} {{number_format($hablador['precio'],2,',','.')}}</p>
                            </div>
                            <div class="m-2">
